...
def check_angles_and_times(node, angles:list, times:list):
    ...
    assert all(0 <= time <= 5000 for time in times), node._logger.error('times was not within the interval [1000, 5000]')
    assert (2000 <= angles[0] <= 13500) or (angles[0] == -1), node._logger.error(f'servo 1 was not within the interval [0, 11000] or -1, got {angles[0]}')
